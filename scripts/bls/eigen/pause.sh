...
forge script script/eigenlayer/bls/PauseWavsRegistration.s.sol --rpc-url "$RPC_URL" --private-key "$FUNDED_KEY" --broadcast || handle_error "Failed to pause WAVS registration"
