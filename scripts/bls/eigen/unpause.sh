...
forge script script/eigenlayer/bls/UnpauseWavsRegistration.s.sol --rpc-url "$RPC_URL" --private-key "$FUNDED_KEY" --broadcast --skip-simulation || handle_error "Failed to unpause WAVS registration"
