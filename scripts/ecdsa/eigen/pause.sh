...
forge script script/eigenlayer/ecdsa/PauseWavsRegistration.s.sol --rpc-url "$LOCAL_ETHEREUM_RPC_URL" --private-key "$FUNDED_KEY" --broadcast || handle_error "Failed to pause WAVS registration"
