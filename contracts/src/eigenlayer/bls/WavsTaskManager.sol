    ...
    IWavsTaskManager
{
    ...
    function respondToTask(
        ...
        require(
            ...
            WavsTaskManager__SuppliedTaskDoesNotMatchOneRecordedInContract()
        );
        // some logical checks
        require(
    ...
    function raiseAndResolveChallenge(
        ...
        require(
            ...
            WavsTaskManager__TaskHasNotBeenRespondedToYet()
        );
        require(
        ...
        require(
            ...
            WavsTaskManager__PubkeysOfNonSigningOperatorsSuppliedByChallengerAreNotCorrect()
        );
