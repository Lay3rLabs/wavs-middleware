...
library WavsMiddlewareDeploymentLib {
    ...
    function deployContracts(
        ...
        result.WavsServiceManager = UpgradeableProxyLib.setUpEmptyProxy(
            proxyAdmin
        );
        ...
        bytes memory WavsServiceManagerUpgradeCall = abi.encodeCall(
            WavsServiceManager.initialize,
            (msg.sender, msg.sender)
        );
        UpgradeableProxyLib.upgradeAndCall(
            result.stakeRegistry,
            stakeRegistryImpl,
            stakeRegistryUpgradeCall
        );
        UpgradeableProxyLib.upgradeAndCall(
            result.WavsServiceManager,
            WavsServiceManagerImpl,
            WavsServiceManagerUpgradeCall
        );
    ...
    function readDeploymentJson(
        ...
        data.WavsServiceManager = json.readAddress(
            ".contracts.WavsServiceManager"
        );
    ...
    function writeDeploymentJson(
        ...
        address proxyAdmin = address(
            UpgradeableProxyLib.getProxyAdmin(data.WavsServiceManager)
        );
